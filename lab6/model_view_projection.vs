...
void main()
{
  ...
  if (is_moon) {
	...
	vec4 projected = proj * view * transformations;
	pos_cs_in = projected;
  } else {
	pos_cs_in = proj * view * model_matrix * pos;
  }
}
